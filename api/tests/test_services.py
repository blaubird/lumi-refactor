...
from app.services.ai import generate_embedding, find_relevant_faqs, get_rag_response
...
async def test_find_relevant_faqs(mock_openai_client, test_db, monkeypatch):
    ...
    with patch('app.models.faq.FAQ.embedding') as mock_embedding:
        ...
        # Call the function
        faqs = await find_relevant_faqs(test_db, "test_tenant", "meaning of life", top_k=1)
